...
; DEBUG: Show what will be pasted
MsgBox, DEBUG FINAL TEXT:`n`nPriorDate: %PriorDate%`n`nPriorTimeFormatted: %PriorTimeFormatted%`n`nPriorDescript1: %PriorDescript1%`n`nPriorReport: %PriorReport%`n`nPriorImages: %PriorImages%`n`nFINAL:`n%FinalText%
